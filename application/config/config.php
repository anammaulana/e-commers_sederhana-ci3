...
|
*/
$config['encryption_key'] = 'hgvhjsgfyfakjakhjgfhgaf';
...
|
*/
$config['sess_driver'] = 'files'; // Atau gunakan konfigurasi lainnya sesuai kebutuhan
$config['sess_cookie_name'] = 'ci_session';
$config['sess_expiration'] = 7200;
$config['sess_save_path'] = APPPATH . 'cache/sessions'; // Sesuaikan dengan path yang valid
